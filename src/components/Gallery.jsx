...
export default function Gallery() {
  ...
  const items = GAL.filter((g) => g.categories.includes(tab));
    ...
    <section id="gallery" className="py-28 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <Reveal>
          ...
          <p
            className="font-body text-gray-400 max-w-md leading-relaxed"
            style={{ fontSize: 16 }}
          >
            Browse our premium portfolio of prints, banners, and creative
            designs. Click any image to view full-size.
          </p>
        </Reveal>
      ...
      {lightbox !== null && (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 px-14">
            <img
              src={show[lightbox].imageUrl}
              alt={show[lightbox].title}
              className="lb-img"
            />
            ...
            {show.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 8,
                  background:
                    i === lightbox ? "#e8006f" : "rgba(255,255,255,.3)",
                }}
              />
            ))}
          </div>
